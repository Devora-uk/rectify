  ...
  return <footer className="relative overflow-hidden bg-[#020d3b] text-white">
    ...
    <div className="section-shell relative py-16 lg:py-20">
      <div className="grid gap-12 border-b border-white/10 pb-14 lg:grid-cols-[1.5fr_.8fr_.8fr_1.2fr]">
        ...
        <div><h3 className="footer-title">Explore</h3><div className="footer-links"><Link href="/about">About</Link><Link href="/services">Expertise</Link><Link href="/areas">Locations</Link><Link href="/areas/germany">Germany</Link><Link href="/areas/united-kingdom">United Kingdom</Link></div></div>
        ...
        <div><h3 className="footer-title">Talk to us</h3><div className="footer-links"><a className="flex items-start gap-2" href="mailto:info@rectifyinternational.com"><Mail className="mt-0.5 h-4 w-4 shrink-0" />info@rectifyinternational.com</a><a className="flex items-center gap-2" href="tel:+447399836007"><Phone className="h-4 w-4" />+44 7399 836 007</a><Link href="/contact" className="!text-[#24ddd5]">Contact Rectify <ArrowUpRight className="inline h-4 w-4" /></Link></div></div>
      </div>
